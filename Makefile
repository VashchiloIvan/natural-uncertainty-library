.PHONY up:
up:
	swig -csharp -namespace NaturalUncertaintyCsharpApi -c++ -outdir ../natural-uncertainty-csharp-api/natural-uncertainty-csharp-api ./wrapper/csharp/natural-uncertainty-lib.l
